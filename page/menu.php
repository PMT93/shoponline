...
<div>
<a href="index.php">
    <img  class ="mySlider"src="photo/PMT.png" width="180px" height="80px" >
</a>
       </div>
       <ul class="list_menu">
       ...
       <div>
       <a style="text-decoration: none;" class="giohang_css" href="./chitiet.php?quanly=giohang"><i style="color: yellow;" class="fas fa-cart-plus fa-2x"></i>
       <?php
