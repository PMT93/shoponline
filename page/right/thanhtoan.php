...
require('../../carbon/autoload.php');
    ...
    if( $cart_query){
      ...
      mysqli_query($mysqli,$insert_order_details);          
        ...
        $tieude = "Đặt hàng website pmtshop.itc thành công!";
		$noidung = "<p>Cảm ơn quý khách đã đặt hàng của PMT-Shop , đơn hàng sẽ được gửi sớm nhất. <br> Mã đơn hàng : ".$code_order."</p>";
